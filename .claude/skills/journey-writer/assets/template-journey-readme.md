---
title: Template do README.md de .journey/
description: Base copiavel para o README.md inicial da pasta .journey/, com proposito, principio central, estrutura e regras de uso.
metadata:
...
# Template do README.md de .journey/

Copie o bloco abaixo para `.journey/README.md` e adapte ao projeto.
